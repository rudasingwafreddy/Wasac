...
$sql="INSERT INTO  users(username,email,password,user_role) VALUES(:username,:email,:password,:userrole)";
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <form method="post">
                                                    ...
                                                    <div class="form-group has-success">
                                                		...
                                                		<div class="">
                                                			<input type="email" name="email" class="form-control" required="required" id="success">
