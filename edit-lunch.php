...
$id=intval($_GET['id']);
$sql="UPDATE  lunch SET e_worker=:e_worker,amaount=:amount,e_date=:e_date WHERE id=:id ";
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Update Lunch Expense</h2>
                                </div>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
            							...
            							<li><a href="manage-lunch.php">Lunch Expense</a></li>
            							<li class="active">Update Lunch Details</li>
            						</ul>
                                </div>
...
{   ?>
                                                    ...
                                                    <div class="form-group has-success">
                                                        <label for="success" class="control-label">Worker</label>
                                                		<div class="">
                                                			<input type="text" value="<?php echo htmlentities($result->e_worker);?>" name="e_worker" class="form-control" required="required" id="success">
                                                            <span class="help-block">Eg: John ...</span>
                                                		</div>
                                                	</div>
                                                    <div class="form-group has-success">
                                                        <label for="success" class="control-label">Amount</label>
                                                		<div class="">
                                                			<input type="number" value="<?php echo htmlentities($result->amaount);?>" name="amount" class="form-control" required="required" id="success">
                                                            <span class="help-block">Eg: 100,000...</span>
                                                		</div>
                                                	</div>
